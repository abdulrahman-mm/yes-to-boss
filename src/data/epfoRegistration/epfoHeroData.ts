...
export const epfoHeroData: serviceHeroTypes = {
  heading: "EPFO Registration",
  subHeading:
    "We ensure compliance and secure your employees’ future with fast EPFO registration and complete online PF support, with zero complications.",
