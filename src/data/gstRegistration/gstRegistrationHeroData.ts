...
export const gstRegistrationHeroData: serviceHeroTypes = {
  heading: "GST Registration",
  subHeading:
    "We make GST registration simple by handling documents, filing, and approvals so your business stays compliant without the hassle.",
