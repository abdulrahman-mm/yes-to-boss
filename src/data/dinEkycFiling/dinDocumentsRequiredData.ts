...
export const dinEKycFilingHeroData: serviceHeroTypes = {
  heading: "DIN eKYC Filing (Form DIR-3 KYC)",
  subHeading:
    "Stay compliant with MCA regulations by completing your annual DIN eKYC filing with fast processing and zero complications.",
