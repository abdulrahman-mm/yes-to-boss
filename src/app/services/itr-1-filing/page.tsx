...
import {itr1FaqData,itr1HeroData} from '@/data'
...
const ITR1InternalAudit = dynamic(
  () => import("@/components/services/ITR1/ITR1InternalAudit"),
  { ssr: false, loading: () => <p>Loading Internal Audit...</p> }
);
