...
export const metadata: Metadata = {
  title: "Sole Proprietorship Registration Online",
  description:
    "Register your sole proprietorship online with YesToBoss. Get expert support, quick processing, and complete legal compliance to start your business in India.",
  keywords: [
    "Sole proprietorship registration online",
    "Sole proprietorship firm registration online",
    "Online business registration",
