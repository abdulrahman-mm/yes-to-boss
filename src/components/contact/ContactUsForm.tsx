    ...
    <section className="min-h-screen overflow-hidden">
      ...
      <div className="relative">
        ...
        {[
          ...
          // [
          //   "h-[250px] w-[250px] md:h-[350px] md:w-[350px] bg-gradient-to-b from-[#ffffff] to-[pink] via-[#ffffff] rounded-full right-0 md:right-10 top-40",
          //   "h-[200px] w-[200px] md:h-[307px] md:w-[307px] bg-gradient-to-b from-[#ffffff] to-[pink] via-[#ffffff]  rounded-full bottom-10 left-5",
          //   "h-[130px] w-[130px] md:h-[185px] md:w-[185px] bg-gradient-to-b from-[#ffffff] to-[pink] via-[#ffffff]  rounded-full top-10 left-20 md:left-48",
          //   "h-[100px] w-[100px] md:h-[128px] md:w-[128px] bg-gradient-to-b from-[#ffffff] to-[pink] via-[#ffffff]  rounded-full bottom-32 left-[40%]",
          //   "h-[100px] w-[100px] md:h-[119px] md:w-[119px] bg-gradient-to-b from-[#ffffff] to-[pink] via-[#ffffff]  rounded-full bottom-5 right-10 md:right-36",
          // ]
          .map((cls, i) => (
            <div
              key={i}
            ...
            {/* <div className="px-3 sm:px-6 md:px-10 pt-8 md:pt-10 pb-10 basis-full rounded-b-4xl lg:rounded-e-4xl lg:rounded-bl-none bg-black/50 flex flex-col gap-6 md:gap-10">
              {[
                ...
                <div
                  ...
                  className="flex flex-col md:flex-row justify-between gap-6 md:gap-10 font-inter font-medium will-change-transform"
                >
              ...
              <div
                ...
                className="flex flex-col gap-1 font-inter font-medium will-change-transform"
              >
                <label>Message</label>
                <textarea
              ...
              <div className="flex flex-col gap-1 items-end will-change-transform">
                <button
