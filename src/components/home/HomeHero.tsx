...
//         <div className="flex relative z-0 items-center justify-center gap-5 lg:gap-8 xl:gap-10 px-5 sm:px-8 md:px-10  xl:px-16 mt-14 lg:mt-16 xl:mt-24">
//           {/* Left Cards */}
//           <div className="hidden lg:flex flex-col    justify-between h-[75vh]">
//             <div
//               ref={addToRefs}
  ...
  return (
    <main>
      <div className="py-2 pb-10 bg-no-repeat bg-[url('/images/home-hero-bg-image.svg')] bg-cover bg-center text-white">
        ...
        <div className="flex relative z-0 items-center justify-center gap-5 lg:gap-8 xl:gap-10 px-5 sm:px-8 md:px-10 xl:px-16 mt-28 lg:mt-16 xl:mt-24">
          {/* Left Cards */}
          <div className="hidden lg:flex flex-col justify-between h-[75vh]">
            <div
              ref={addToRefs}
            ...
            <div ref={addToRefs}>
              ...
              <div className="w-44 lg:w-52 xl:w-72 h-56 xl:h-48 rounded-xl hover:scale-125 transition-all duration-700 bg-gradient-to-r from-[#37373726] via-[#FFFFFF26] to-[#3D3D3D26] border border-[#FFFFFF]/15 p-5">
                <Image
                  ...
                  className="hidden lg:block"
                />
                <h2 className="mt-5 font-Bricolage_Grotesque font-medium">
                  Accounting Services
                </h2>
                <h3 className="text-xs mt-3 font-Bricolage_Grotesque">
                  From bookkeeping to balance sheets, we handle it all. Gain
                  clarity, control, and peace of mind.
                </h3>
              </div>
