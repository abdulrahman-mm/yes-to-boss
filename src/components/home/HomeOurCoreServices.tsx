...
//   // Smooth lerp animation for floating image position
//   useEffect(() => {
//     const lerp = (start: number, end: number, factor: number) =>
//       start + (end - start) * factor;
...
//       if (imageRef.current) {
//         imageRef.current.style.transform = `translate3d(${currentPosition.current.x}px, ${currentPosition.current.y}px, 0) scale(${imageRef.current.dataset.scale || 0.5})`;
//       }
...
//   // Smooth hover animation for floating image
//   useLayoutEffect(() => {
//     if (imageRef.current) {
//       if (hovered !== null) {
//         imageRef.current.src = services[hovered].image;
//         gsap.fromTo(
//           imageRef.current,
//           {
//             opacity: 0,
...
//             onUpdate: () => {
//               if (imageRef.current) {
//                 imageRef.current.dataset.scale = "1";
//               }
//             },
//           }
//         );
...
//           onUpdate: () => {
//             if (imageRef.current) {
//               imageRef.current.dataset.scale = "0.5";
//             }
//           },
//         });
//       }
