...
const HomeTaxBusinessConsultingService = () => {
  ...
  return (
    <section ref={sectionRef} className="relative p-5 sm:p-8 md:p-10 lg:p-14 xl:p-16 bg-black">
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-24 xl:gap-28 items-start lg:items-center min-h-[100vh] text-white relative z-10">
        {/* Left Side */}
        <div className="w-full lg:w-[60%]">
          <p
          ...
          <div className="flex flex-col gap-5 mt-10" ref={cardsWrapperRef}>
            {[
              ...
              <div key={i} className="card flex items-start border border-[#FFFFFF]/30 hover:border-white hover:bg-[#1a1a1a] transition-all duration-500 rounded-xl px-4 sm:px-6 py-5 gap-4 sm:gap-5 backdrop-blur-sm shadow-md tra">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm mt-2 text-gray-400">{item.subText}</p>
                </div>
              </div>
            ))}
          </div>
