 ...
 const HomeTaxBusinessConsultingService = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
    >
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-32 items-start lg:items-center min-h-[100vh] text-white relative z-10">
        {/* Left Side */}
        <div className="w-full lg:w-[60%]">
          <p
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight general-sans overflow-hidden"
            ref={headingRef}
          >
            Tax & Business Consulting Services
          </p>
