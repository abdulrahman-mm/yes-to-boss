    ...
    <section className="bg-white min-h-screen pt-2 pb-5 md:pb-0 general-sans px-4 sm:px-8 md:px-12 lg:px-16">
      ...
      <div className="flex justify-center items-center py-16 md:py-28 flex-col gap-2 text-center">
        ...
        <p
          ...
          className="font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-6xl will-change-transform translate-z-0"
        >
          in <span className="text-[#6A6A6A]">Chennai</span>
        </p>
        ...
        >
          Get accurate and timely GST return filing, monthly, quarterly, or
          annually, to stay compliant and avoid penalties without hassle.
        </p>
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-28 justify-between items-center lg:items-start">
        ...
        >
          ...
          <BlurText
            text="What Is GST Return Filing?"
            delay={50}
            animateBy="words"
            direction="top"
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-sm leading-5 font-medium font-Bricolage_Grotesque">
            A GST Return is a detailed statement submitted to the tax
            authorities capturing your business’s financial activity —
            purchases, sales, output tax collected, and input tax paid. Filing
            GST returns is mandatory for all GST-registered businesses in India.
            These returns enable the government to determine your net tax
            liability. Based on your turnover and business type, filings may be
        ...
        >
          <img
            src="/images/ITR1-Return-Filing-hero-image1.svg"
            alt=""
...
export default GSTReturnFilingHero;
